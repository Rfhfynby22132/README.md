...
from сonfig import TOKEN,DATABASE
from text import tetx_1
...
def start_command(message):
    bot.send_message(message.chat.id, """Привет! Я бот-менеджер проеектов
...
def info(message):
    bot.send_message(message.chat.id, text=tetx_1)
